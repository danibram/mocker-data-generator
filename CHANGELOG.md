...
* added min max for value generation randomly with tests. thanks [@darkmiru](https://github.com/darkmiru) ([5eaa6f4](https://github.com/danibram/mocker-data-generator/commit/5eaa6f4))
